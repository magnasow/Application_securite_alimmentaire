...
public class ProduitsController {
    ...
    @DeleteMapping("/deleteProduits/{idProduit}")
    public ResponseEntity<Void> deletedProduits(@PathVariable Integer idProduit) {
        produitsService.deletedProduits(idProduit);
